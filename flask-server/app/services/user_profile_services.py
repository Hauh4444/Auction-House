...
class UserProfileService:
    ...
    def get_all_user_profiles():
        ...
        """
        user_profiles = UserProfileMapper.get_all_user_profiles()
    ...
    def get_user_profile(user_id):
        ...
        """
        profile = UserProfileMapper.get_user_profile(user_id)
        if profile:
    ...
    def delete_user_profile(user_id):
        ...
        """
        deleted_rows = UserProfileMapper.delete_user_profile(user_id)
        if deleted_rows:
