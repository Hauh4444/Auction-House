...
class ListingMapper:
    ...
    @staticmethod
    def get_all_listings(args, session=None):
    ...
    @staticmethod
    def get_listing_by_id(listing_id, session=None):
    ...
    @staticmethod
    def create_listing(data, session=None):
    ...
    @staticmethod
    def update_listing(listing_id, data, session=None):
    ...
    @staticmethod
    def delete_listing(listing_id, session=None):
