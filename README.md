...
4. Run the `pip install flask flask-cors flask-mysql flask-login flask-session flask-limiter python-dotenv redis pytest` command to install the necessary dependencies.
